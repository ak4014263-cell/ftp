...
# Service routing configuration (environment variables allow Docker / VPS routing)
SERVICES = {
    "auth": os.getenv("AUTH_SERVICE_URL", "http://localhost:8001"),
    "user": os.getenv("USER_SERVICE_URL", "http://localhost:8002"),
    "job": os.getenv("JOB_SERVICE_URL", "http://localhost:8003"),
    "profile": os.getenv("PROFILE_SERVICE_URL", "http://localhost:8004"),
    "application": os.getenv("APPLICATION_SERVICE_URL", "http://localhost:8003"),
    "automation": os.getenv("AUTOMATION_SERVICE_URL", "http://localhost:8006"),
    "email": os.getenv("EMAIL_SERVICE_URL", "http://localhost:8007"),
